<template>
  <section class="contact">
    ...
    <section class="contact__links">
      ...
      <div><a href="https://linkedin.com/austincaron" class="contact__link contact__link--linkedin" target="_blank">linkedin<span class="title--period">.</span>com/austincaron</a></div>
    ...
    meta: [
      {
        hid: 'description',
        name: 'description',
        content: `Need a new site? Online presence? Just want to talk? Choose any one of the links and you'll get a response, I promise.`
      },
      {
        hid: 'og:title',
        property: 'og:title',
        content: 'Austin Caron - Contact Me'
      },
      {
        hid: 'og:description',
